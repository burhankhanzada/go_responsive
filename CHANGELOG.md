...
Packages with other changes:
 ...
 - [`go_responsive` - `v0.4.4`](#go_responsive---v044)
 - [`go_responsive_annotation` - `v0.4.4`](#go_responsive_annotation---v044)
 - [`go_responsive_generator` - `v0.4.4`](#go_responsive_generator---v044)

---

#### `go_responsive` - `v0.4.4`

#### `go_responsive_annotation` - `v0.4.4`

 - Bump "go_responsive_annotation" to `0.4.4`.

#### `go_responsive_generator` - `v0.4.4`
...
Packages with other changes:
 ...
 - [`go_responsive` - `v0.4.2`](#go_responsive---v042)
 - [`go_responsive_annotation` - `v0.4.2`](#go_responsive_annotation---v042)
 - [`go_responsive_generator` - `v0.4.2`](#go_responsive_generator---v042)

---

#### `go_responsive` - `v0.4.2`

 - **FIX**: Update depencies and code according to it.

#### `go_responsive_annotation` - `v0.4.2`

 - Bump "go_responsive_annotation" to `0.4.2`.

#### `go_responsive_generator` - `v0.4.2`
...
Packages with other changes:
 ...
 - [`go_responsive` - `v0.4.1`](#go_responsive---v041)
 - [`go_responsive_annotation` - `v0.4.1`](#go_responsive_annotation---v041)
 - [`go_responsive_generator` - `v0.4.1`](#go_responsive_generator---v041)

---

#### `go_responsive` - `v0.4.1`

 - Update preview

#### `go_responsive_annotation` - `v0.4.1`

 - Update preview

#### `go_responsive_generator` - `v0.4.1`
